...
public class EditableAndRewiteItems {
	...
	SaleOrderHVO.CCUSTOMERID, SaleOrderHVO.CHRECEIVECUSTID,
			SaleOrderHVO.CINVOICECUSTID, SaleOrderHVO.CDEPTID,
			SaleOrderHVO.CDEPTVID, SaleOrderHVO.CEMPLOYEEID,
			SaleOrderHVO.VTRANTYPECODE, SaleOrderHVO.CORIGCURRENCYID,
			SaleOrderHVO.CPAYTERMID, SaleOrderHVO.CTRADEWORDID,
			SaleOrderHVO.NDISCOUNTRATE, SaleOrderHVO.CBALANCETYPEID,
			SaleOrderHVO.BADVFEEFLAG, SaleOrderHVO.BPRECEIVEFLAG,
			SaleOrderHVO.DBILLDATE, SaleOrderHVO.BSENDENDFLAG,
			SaleOrderHVO.BOUTENDFLAG, SaleOrderHVO.BINVOICENDFLAG,
			SaleOrderHVO.BCOSTSETTLEFLAG, SaleOrderHVO.BARSETTLEFLAG,
			/** ---------- 表头 ---------- */
			SaleOrderHVO.CTRADEWORDID, SaleOrderHVO.VREVISEREASON,
			SaleOrderHVO.VNOTE,
			/** -------表头自定义项------ **/
	...
	public static final String[] BODYEDITABLEITEMKEY = new String[] {
			...
			SaleOrderBVO.DBILLDATE,
			SaleOrderBVO.CFACTORYID,
	...
	SaleOrderHVO.VDEF1, SaleOrderHVO.VDEF2, SaleOrderHVO.VDEF3,
			...
			SaleOrderHVO.VDEF19, SaleOrderHVO.VDEF20,
			/** -------修订信息------- */
			SaleOrderHVO.CREVISERID, SaleOrderHVO.APPROVER,
